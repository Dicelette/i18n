...
- <CL>expression</CL>: For the [`/calc`](../usage/model/calc.mdx#based-on-statistic-calc), [`/dbroll`](../usage/model/dice.mdx#dbroll-dbroll) et [`/dbd`](../usage/model/dice.mdx#dbd-dbd)
