...
- <CL>expression</CL>: For the [`/calc`](../usage/model/calc.mdx#based-on-statistics-calc), [`/dbroll`](../usage/model/dice.mdx#dbroll-dbroll), and [`/macro`](../usage/model/dice.mdx#macro-macro) commands.
