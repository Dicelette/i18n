...
- When editing a sheet, statistics are not checked against the total or a maximum. 
- Moreover, it is impossible to control the number of points spent per statistic in systems where spending 1 point in a statistic is not equivalent to 1 statistic point.
